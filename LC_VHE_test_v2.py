...
class take_data:
	...
	# So before we decided to calculate our own Normalization values, we used the given LAT Flux
	# Now it's just useful for graphing
	# I mean when I'm choosing between lean ground turkey I don't care if it's 98% of 99% lean 
